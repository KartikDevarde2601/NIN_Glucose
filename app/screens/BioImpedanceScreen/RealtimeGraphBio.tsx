...
export const RealTimeGraphBio: FC<RealTimeGraphProps> = ({
  value,
  title,
  graphColor,
  ...
  const calculatePath = useCallback(
    (currentData: DataPoint[]) => {
      let maxValue = Math.max(...currentData.map(d => d.value));
      let minValue = Math.min(...currentData.map(d => d.value));
  ...
  return (
    <View style={$graphWrapper}>
      <TextPaper variant="titleMedium">{title}</TextPaper>
